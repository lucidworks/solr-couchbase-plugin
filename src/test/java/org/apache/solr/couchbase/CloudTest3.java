...
public class CloudTest3 extends LuceneTestCase {
...
//    String testHome = SolrTestCaseJ4.TEST_HOME();
    miniCluster = new MiniSolrCloudCluster(NUM_SERVERS, null, new File(TEST_DIR + File.separator + "conf", "solr-no-core.xml"),
      null, null);
  }
  ...
  public void testBasics() throws Exception {
    ...
    try {
      ...
      uploadConfigToZk(TEST_DIR + File.separator + "conf", configName);
